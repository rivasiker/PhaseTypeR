...
Discrete phase-type distributions can be created in `phasty` using the very same `DPH()` function used for the continuous case, but specifying a sub-intensity matrix that meets the requirements for a discrete phase-type distribution:
