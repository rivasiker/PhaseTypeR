...
In the above graph the initial probabilities are represented as purple arrows, while rates are represented by grey arrows. 
...
```{r}
x <- seq(0, qPH(0.95, rph), length.out = 100)
pdf <- dPH(x, rph)
cdf <- pPH(x, rph)
