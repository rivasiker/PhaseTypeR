...
$$
i.e. the reward transformation of $\boldsymbol{T}$ and $\boldsymbol{\pi}$ using $r_j$. We say that the multivariate variable $\boldsymbol{Y} = (Y_1,\  Y_2,\  ...\,,\  Y_n)$ is multivariate phase-type distributed and write $\boldsymbol{Y} \sim MPH^*(\boldsymbol{T},\  \boldsymbol{\pi},\  \boldsymbol{R})$.
